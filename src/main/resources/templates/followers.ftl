...
<@override name="title">${curUser.name}的粉丝列表 - 智乎</@override>
                            ...
                            <div class="zm-profile-card zm-profile-section-item zg-clear no-hovercard">
                                ...
                                <div class="zm-list-content-medium">
                                    ...
                                    <div class="details zg-gray">
                                        ...
                                        /
                                        <a target="_blank" href="#" class="zg-link-gray-normal">${vo.answerCount} 回答</a>
                                        /
                                        <a target="_blank" href="#" class="zg-link-gray-normal">${vo.agreeCount} 赞同</a>
                                    </div>
                                </div>
                            </div>
                            </#list>
