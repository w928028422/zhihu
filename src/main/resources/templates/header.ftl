...
<head>
    ...
    <link rel="search" type="application/opensearchdescription+xml" href="https://nowcoder.com/static/search.xml" title="智乎">
    ...
    <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
        ...
        <div class="top-nav-profile">
            ...
            <ul class="top-nav-dropdown" id="top-nav-profile-dropdown" aria-labelledby=":0">
                ...
                <li>
                    <a href="/settings" tabindex="-1" id=":3">
        ...
        <div role="search" id="zh-top-search" class="zu-top-search">
            <form method="POST" action="/search" id="zh-top-search-form" class="zu-top-search-form">
                <input type="hidden" name="type" value="content">
                <label for="q" class="hide-text">智乎搜索</label><input type="text" class="zu-top-search-input" id="q" name="q" autocomplete="off" value="" placeholder="搜索你感兴趣的内容..." role="combobox" aria-autocomplete="list">
